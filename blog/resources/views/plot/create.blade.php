...
<div class="container-fluid py-4">
    ...
    <form action="{{ route('plot.store') }}" method="POST" id="form">
    @csrf
      <div class="row">
        <div class="col-md-20">
          <div class="card">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" min="1" placeholder="1" name="total_team">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Team Leader</label>
                    <input class="form-control text-uppercase" type="text" placeholder="Full Name" name="team_leader">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Record By</label>
                    <input class="form-control text-uppercase" type="text" placeholder="Full Name" name="record_by">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control text-uppercase" type="text" placeholder="AA-1-YYMMDD-1A" name="plot_name">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Location</label>
                    <input class="form-control text-uppercase" type="text" placeholder="ABC" name="location" id="location">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Latitude</label>
                    <input class="form-control" type="number" placeholder="0.00000" step="0.00001" name="latitude" id="latitude">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Longitude</label>
                    <input class="form-control" type="number" placeholder="000.00000" step="000.00001" name="longitude" id="longitude">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Average Slope</label>
                    <input class="form-control" type="number" placeholder="00.00" step="00.0001" name="avg_slope">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="js-example-basic-single form-control" name="strata_type" id="strata_type">
                      <option value="" selected>Select Strata Type</option>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" placeholder="0" min="0" name="gps_accuracy">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Resam</label>
                    <input class="form-control" type="number" value="10" min="0" name="resam"> 
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Typography</label>
                    <input class="form-control" type="number" value="3" min="0" name="typography">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Elevation</label>
                    <input class="form-control" type="number" placeholder="0" min="0" name="elevation">
                  </div>
                </div>
              </div>
