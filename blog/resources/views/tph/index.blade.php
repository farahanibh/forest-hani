...
@section('content') 
    ...
    <body>
        <!--<h4 class="center"> Stand Density</h4>-->
        <div class="row mt-4">
            <div class="col-lg-15 mb-lg-0 mb-4">
              <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                  <h6 class="text-capitalize">Stand Density</h6>
                ...
                <div class="card-body p-3">
                    <!--Average Tph for each location-->
                    <div style="width:100%;">
                         <canvas id="tph-chart"  class="chart-canvas"></canvas>
                    </div>

                    <script>
                        // Get the average tph data from the query
                        var data = {!! $averages !!};
                    
                        // Extract the location and average_tph values into separate arrays
                        var locations = data.map(function(item) { return item.location; });
                        var tphValues = data.map(function(item) { return item.average_tph; });
                        ...
                        // Create the chart
                        var ctx = document.getElementById('tph-chart').getContext('2d');
                        var chart = new Chart(ctx, {
                            type: 'bar',
                            data: {
                                labels: locations,
                                datasets: [{
                                    label: 'Stand Density Each Location',
                                    data: tphValues,
